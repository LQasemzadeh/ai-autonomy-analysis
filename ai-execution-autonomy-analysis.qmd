...
<div class="pfh-cover-paper-title">
The Impact of AI Execution Autonomy on User Task Performance and Intervention Behavior in Digital Workflows
</div>

<div class="pfh-cover-main">

<div class="pfh-cover-type">
Practical Project
</div>

<div class="pfh-cover-subtitle">
Submitted as part of the degree program<br>
“User Experience Management & Design”
</div>

<div class="pfh-cover-degree">
In partial fulfillment of the requirements for the degree of<br>
“Master of Science”
</div>

<div class="pfh-cover-university">
PFH Private University Göttingen
</div>

<div class="pfh-cover-date">
May 2026
</div>

</div>

<div class="pfh-cover-bottom">
Written by: Zahra Qasemzadeh<br>
...
<w:p>
  ...
  <w:r>
    ...
    <w:t>The Impact of AI Execution Autonomy on User Task Performance and Intervention Behavior in Digital Workflows</w:t>
  </w:r>
</w:p>
<w:p>
  <w:pPr>
...
<w:p>
  ...
  <w:r>
    <w:rPr><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr>
    <w:t xml:space="preserve">Submitted as part of the degree program</w:t>
  </w:r>
  <w:r>
    <w:rPr><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr>
    <w:br/>
  ...
  <w:r>
    <w:rPr><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr>
    <w:t>“User Experience Management &amp; Design”</w:t>
  </w:r>
</w:p>
<w:p>
  <w:pPr>
...
<w:p>
  ...
  <w:r>
    <w:rPr><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr>
    <w:t>PFH Private University Göttingen</w:t>
  </w:r>
</w:p>
<w:p>
  <w:pPr>
...
<w:p>
  ...
  <w:r>
    <w:rPr><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr>
    <w:t>Written by: Zahra Qasemzadeh</w:t>
  </w:r>
</w:p>
<w:p>
  ...
  <w:r>
    <w:rPr><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr>
    <w:t>Supervisor: Prof. Dr. Hubert Schüle</w:t>
  </w:r>
</w:p>
<w:p>
  <w:r>
...
<a href="https://uwlzwc-ladan.shinyapps.io/ai-autonomy-analysis/" target="_blank"
   style="display:inline-block; padding: 0.5rem 1.1rem; background:#1f4e79; color:#fff;
          border-radius:4px; font-size:11pt; text-decoration:none; font-family:Arial,sans-serif;">
...
completion_time_data <- data_with_time |>
  dplyr::group_by(session_id, mode) |>
  dplyr::summarise(
    started = any(action == "TASK_STARTED"),
    completed = any(action == "TASK_COMPLETED"),
...
dashboard_export <- list(

  metadata = list(
    title = "AI Execution Autonomy Study",
    total_started_sessions = 160,
    conditions = c("Manual", "Assistance", "Execution")
  ),

  completion_time_summary = completion_time_summary_clean,

  completion_time_distribution =
    completion_time_data_clean |>
    dplyr::select(mode, completion_time),

  completion_time_kruskal = list(
    statistic = round(as.numeric(kruskal_completion$statistic), 3),
    p_value = kruskal_completion$p.value,
    epsilon_squared = round(as.numeric(epsilon_sq), 3)
  ),

  completion_time_posthoc =
    pairwise_table,
  ...
  intervention_distribution =
    intervention_count_by_mode |>
    dplyr::select(mode, intervention_count),

  intervention_kruskal = list(
    statistic = round(as.numeric(kruskal_intervention_count$statistic), 3),
    p_value = kruskal_intervention_count$p.value,
    epsilon_squared = round(as.numeric(epsilon_sq_ic), 3)
  ),

  intervention_posthoc =
    pairwise_intervention_count_table,
  ...
  error_test = list(
    statistic = round(as.numeric(chi_error$statistic), 3),
    p_value = chi_error$p.value,
    cramers_v = round(as.numeric(cramers_v_error), 3)
  ),
  ...
  abandonment_test = list(
    statistic = round(as.numeric(chi_abandonment$statistic), 3),
    p_value = chi_abandonment$p.value,
    cramers_v = round(as.numeric(cramers_v_abandonment), 3)
  ),

  abandonment_pairwise =
    pairwise_abandonment_table,

  abandonment_odds_ratios =
    or_abandonment_table,

  task_outcomes =
    task_outcome_by_mode
)
