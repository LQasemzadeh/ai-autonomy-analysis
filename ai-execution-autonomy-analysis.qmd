...
Statistical analyses were selected according to the measurement level of the respective variables. Differences in task completion time across autonomy conditions were assessed using the Kruskal–Wallis test, followed by pairwise Wilcoxon rank-sum tests as post-hoc comparisons where appropriate. Differences in abandonment across conditions were examined using a chi-square test of independence. For error occurrence and intervention occurrence, proportion-based comparisons were conducted across conditions using proportion tests.
